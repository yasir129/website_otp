...
<div class="login-form box-item">
    <form action="<?php echo base_url("index.php/Admin_con/admin_auth")?>" method="post">
		<div class="avatar">
        ...
        <div style="width:100%;text-align: center;" class="form-group">
	        <b style="color:red;"><?php echo $this->session->userdata('fail_admin');?></b>
	        <?php $this->session->unset_userdata('fail_admin');?>
    	</div>
    </form>
</div>
</body>
